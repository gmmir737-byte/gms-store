...
BEGIN
  ...
  ('iPhone 15 Pro Max 256GB', 'iphone-15-pro-max', 'Experience the ultimate iPhone with titanium design, A17 Pro chip, and advanced camera system.', 'Premium iPhone with titanium design', 134900, 149900, 25, electronics_id, 'Apple', '["https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800"]', '{"Display": "6.7 inch Super Retina XDR", "Storage": "256GB", "Chip": "A17 Pro"}', '{iphone,apple,smartphone}', true, true, true, true, 124900, 'active'),
  ('Samsung Galaxy S24 Ultra', 'samsung-galaxy-s24-ultra', 'Galaxy S24 Ultra with Galaxy AI, S Pen, and 200MP camera.', 'Samsung flagship with AI features', 119999, 134999, 30, electronics_id, 'Samsung', '["https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800"]', '{"Display": "6.8 inch Dynamic AMOLED", "Storage": "256GB", "Camera": "200MP"}', '{samsung,galaxy,android}', true, true, false, false, null, 'active'),
  ...
  -- Fashion Products
  INSERT INTO products (name, slug, description, short_description, price, compare_price, quantity, category_id, brand, images, specifications, tags, is_featured, is_new, is_bestseller, is_flash_sale, flash_sale_price, status) VALUES
  ('Premium Cotton T-Shirt', 'premium-cotton-tshirt', 'Ultra-soft 100% organic cotton t-shirt. Perfect for everyday wear.', 'Classic organic cotton tee', 999, 1499, 200, fashion_id, 'GM Basics', '["https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800"]', '{"Material": "100% Cotton", "Fit": "Regular"}', '{tshirt,cotton,fashion}', true, false, false, false, null, 'active'),
  ...
  -- Toys Products
  INSERT INTO products (name, slug, description, short_description, price, compare_price, quantity, category_id, brand, images, specifications, tags, is_featured, is_new, is_bestseller, is_flash_sale, flash_sale_price, status) VALUES
  ('LEGO Creator Set', 'lego-creator-set', 'Creative building set with 3-in-1 possibilities.', 'Creative 3-in-1 LEGO set', 1999, 2499, 100, toys_id, 'LEGO', '["https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800"]', '{"Pieces": "500+", "Age": "8+"}', '{lego,toys,building}', true, true, true, false, null, 'active'),
